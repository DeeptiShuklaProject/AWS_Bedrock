...
## ![Icon showing a purple letter S with a red dot in the lower right corner.](http://docs.aws.amazon.com/bedrock/latest/userguide/images/models/stability.png) Stability AI — Stable Image Search and Replace
...
Stable Image Search and Replace is Stability AI's model that finds objects in images and replaces them with new content based on text prompts. For more information about model development and performance, see the [model/service card](https://stability.ai/stable-image).
+ **Model launch date:** Oct 2024
+ **Model EOL date:** N/A
...
| --- | --- | --- | --- | --- | 
| bedrock-runtime | stability.stable-image-search-replace-v1:0 | https://bedrock-runtime.{region}.amazonaws.com | us.stability.stable-image-search-replace-v1:0 | Not supported | 
...
Geo Inference ID: `us.stability.stable-image-search-replace-v1:0`
...
params = {'image': image_base64, 'prompt': 'jacket', 'search_prompt': 'sweater'}
