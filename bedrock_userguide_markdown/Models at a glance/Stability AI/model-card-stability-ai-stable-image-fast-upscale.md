...
## ![Icon showing a purple letter S with a red dot in the lower right corner.](http://docs.aws.amazon.com/bedrock/latest/userguide/images/models/stability.png) Stability AI — Stable Image Fast Upscale
...
Stable Image Fast Upscale is Stability AI's model that quickly increases image resolution with minimal processing time. For more information about model development and performance, see the [model/service card](https://stability.ai/stable-image).
+ **Model launch date:** Sep 10, 2024
+ **Model EOL date:** N/A
...
| --- | --- | --- | --- | --- | 
| bedrock-runtime | stability.stable-fast-upscale-v1:0 | https://bedrock-runtime.{region}.amazonaws.com | us.stability.stable-fast-upscale-v1:0 | Not supported | 
...
Geo Inference ID: `us.stability.stable-fast-upscale-v1:0`
