...
## ![Icon showing a purple letter S with a red dot in the lower right corner.](http://docs.aws.amazon.com/bedrock/latest/userguide/images/models/stability.png) Stability AI — Stable Image Outpaint
...
Stable Image Outpaint is Stability AI's model that extends images beyond their original boundaries with contextually coherent content. For more information about model development and performance, see the [model/service card](https://stability.ai/stable-image).
+ **Model launch date:** Nov 24, 2022
+ **Model EOL date:** N/A
...
| --- | --- | --- | --- | --- | 
| bedrock-runtime | stability.stable-outpaint-v1:0 | https://bedrock-runtime.{region}.amazonaws.com | us.stability.stable-outpaint-v1:0 | Not supported | 
...
Geo Inference ID: `us.stability.stable-outpaint-v1:0`
...
params = {'image': image_base64, 'left': 200, 'right': 200, 'up': 200, 'down': 200}
