...
## ![Icon showing a purple letter S with a red dot in the lower right corner.](http://docs.aws.amazon.com/bedrock/latest/userguide/images/models/stability.png) Stability AI — Stable Image Inpaint
...
Stable Image Inpaint is Stability AI's model that fills in masked regions of images with contextually appropriate content based on text prompts. For more information about model development and performance, see the [model/service card](https://stability.ai/stable-image).
+ **Model launch date:** Nov 2022
+ **Model EOL date:** N/A
...
| --- | --- | --- | --- | --- | 
| bedrock-runtime | stability.stable-image-inpaint-v1:0 | https://bedrock-runtime.{region}.amazonaws.com | us.stability.stable-image-inpaint-v1:0 | Not supported | 
...
Geo Inference ID: `us.stability.stable-image-inpaint-v1:0`
