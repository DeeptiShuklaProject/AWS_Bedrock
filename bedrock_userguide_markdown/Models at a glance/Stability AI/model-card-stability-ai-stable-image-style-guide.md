...
## ![Icon showing a purple letter S with a red dot in the lower right corner.](http://docs.aws.amazon.com/bedrock/latest/userguide/images/models/stability.png) Stability AI — Stable Image Style Guide
...
Stable Image Style Guide is Stability AI's model that generates images matching a reference style while following text prompt instructions. For more information about model development and performance, see the [model/service card](https://stability.ai/stable-image).
...
| --- | --- | --- | --- | --- | 
| bedrock-runtime | stability.stable-image-style-guide-v1:0 | https://bedrock-runtime.{region}.amazonaws.com | us.stability.stable-image-style-guide-v1:0 | Not supported | 
...
Geo Inference ID: `us.stability.stable-image-style-guide-v1:0`
