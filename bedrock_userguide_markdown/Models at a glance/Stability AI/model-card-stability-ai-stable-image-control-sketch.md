...
## ![Icon showing a purple letter S with a red dot in the lower right corner.](http://docs.aws.amazon.com/bedrock/latest/userguide/images/models/stability.png) Stability AI — Stable Image Control Sketch
...
Stable Image Control Sketch is Stability AI's model that generates images guided by sketch inputs for controlled image creation. For more information about model development and performance, see the [model/service card](https://stability.ai/stable-image).
+ **Model launch date:** Jul 13, 2023
+ **Model EOL date:** N/A
...
| --- | --- | --- | --- | --- | 
| bedrock-runtime | stability.stable-image-control-sketch-v1:0 | https://bedrock-runtime.{region}.amazonaws.com | us.stability.stable-image-control-sketch-v1:0 | Not supported | 
...
Geo Inference ID: `us.stability.stable-image-control-sketch-v1:0`
