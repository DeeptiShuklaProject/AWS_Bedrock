...
# Chapter 20: Amazon ECS
ch20 = """# Chapter 20: Amazon ECS — Elastic Container Service
...
aws ecs run-task \
    --cluster enterprise-cluster \
    --launch-type FARGATE \
    --task-definition enterprise-api-task:1 \
...
with open(os.path.join(notes_dir, "Chapter_20_Amazon_ECS.md"), "w", encoding="utf-8") as f:
    f.write(ch20)

print("Chapter 20 written.")
