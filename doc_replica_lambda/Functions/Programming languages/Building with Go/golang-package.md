...
1. In the project directory that contains your application's `main.go` file, compile your executable. Note the following:
   ...
   + Set your target [instruction set architecture](foundation-arch.md). OS-only runtimes support both arm64 and x86\_64.
...
#### [ cmd.exe ]
   ...
   In cmd.exe, run one of the following, depending on your target [instruction set architecture](foundation-arch.md). OS-only runtimes support both arm64 and x86\_64.
...
#### [ PowerShell ]
   ...
   In PowerShell, run one of the following, depending on your target [instruction set architecture](foundation-arch.md). OS-only runtimes support both arm64 and x86\_64.
