...
<InteractiveExample 
  ...
  initialCode="dependencies = ['boto3', 'pydantic', 'fastapi', 'uvicorn', 'requests']
...
<Quiz 
  ...
  options=["It provides a standardized, declarative specification for build systems and dependencies defined in PEP 518/621.", "It runs faster in binary mode.", "It is automatically generated by AWS.", "Legacy setup.py files are illegal."] 
  answerIndex=0 
