...
## ![Icon showing a purple letter S with a red dot in the lower right corner.](http://docs.aws.amazon.com/bedrock/latest/userguide/images/models/stability.png) Stability AI — Stable Image Conservative Upscale
...
Stable Image Conservative Upscale is Stability AI's image upscaling model that increases resolution while preserving the original image's details and style. For more information about model development and performance, see the [model/service card](https://stability.ai/stable-image).
...
| --- | --- | --- | --- | --- | 
| bedrock-runtime | stability.stable-conservative-upscale-v1:0 | https://bedrock-runtime.{region}.amazonaws.com | us.stability.stable-conservative-upscale-v1:0 | Not supported | 
...
Geo Inference ID: `us.stability.stable-conservative-upscale-v1:0`
