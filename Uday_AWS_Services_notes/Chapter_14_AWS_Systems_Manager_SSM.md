# Chapter 14: AWS Systems Manager (SSM) — Enterprise Operational Engine
...
1. **Beginner Project**: Basic single-tier AWS Systems Manager (SSM) setup.
