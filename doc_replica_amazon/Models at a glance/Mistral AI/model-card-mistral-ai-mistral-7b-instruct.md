...
## ![Pixelated icon showing a stylized person or avatar with orange and yellow coloring.](http://docs.aws.amazon.com/bedrock/latest/userguide/images/models/mistralai.png) Mistral AI — Mistral 7B Instruct
<a name="model-card-mistral-ai-mistral-7b-instruct-header"></a>

## Model Details
<a name="model-card-mistral-ai-mistral-7b-instruct-details"></a>
...
<a name="model-card-mistral-ai-mistral-7b-instruct-capabilities"></a>
...
| --- | --- | 
|  [See the AWS documentation website for more details](http://docs.aws.amazon.com/bedrock/latest/userguide/model-card-mistral-ai-mistral-7b-instruct.html)  |  [See the AWS documentation website for more details](http://docs.aws.amazon.com/bedrock/latest/userguide/model-card-mistral-ai-mistral-7b-instruct.html)  | 

## Pricing
<a name="model-card-mistral-ai-mistral-7b-instruct-pricing"></a>

For pricing, please refer to the [Amazon Bedrock Pricing](https://aws.amazon.com/bedrock/pricing/) page.

## Programmatic Access
<a name="model-card-mistral-ai-mistral-7b-instruct-programmatic-access"></a>
...
| --- | --- | --- | --- | --- | 
| bedrock-runtime | mistral.mistral-7b-instruct-v0:2 | https://bedrock-runtime.{region}.amazonaws.com | Not supported | Not supported | 
...
## Service Tiers
<a name="model-card-mistral-ai-mistral-7b-instruct-tiers"></a>
...
<a name="model-card-mistral-ai-mistral-7b-instruct-regional-availability"></a>
...
## Quotas and Limits
<a name="model-card-mistral-ai-mistral-7b-instruct-quotas"></a>
...
## Sample Code
<a name="model-card-mistral-ai-mistral-7b-instruct-sample-code"></a>
