...
ch21 = """# Chapter 21: Elastic Load Balancing — ALB & NLB
...
with open(os.path.join(notes_dir, "Chapter_21_Elastic_Load_Balancing.md"), "w", encoding="utf-8") as f:
    f.write(ch21)

print("Chapter 21 written.")
